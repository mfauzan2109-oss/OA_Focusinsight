...
// ASSUMPTION: config/db.js exports a mysql2/promise pool, e.g.:
//   const mysql = require('mysql2/promise');
//   const pool = mysql.createPool({ ... });
//   module.exports = pool;
// If your db.js exports something different (e.g. a plain mysql
// connection, or { pool }), adjust this require accordingly.
...
// ==========================================================================
router.get('/api/printing-production-requests', async (req, res) => {
    try {
...
// ==========================================================================
router.patch('/api/printing-production-requests/:id/status', async (req, res) => {
    try {
        const { id } = req.params;
