...
// GET full ordered steps for one workflow type (edit-workflow.html)
...
// POST a brand new workflow (from new-workflow.html)
...
// PUT (replace) all steps for a workflow type
